...
if VIEW in SEC_PRIORITY:
    ...
    if VIEW == "pred":
        ...
        st.markdown(T.callout(
            "Each plant is carried forward one year. Only <b>one</b> term "
            "actually forecasts anything: the burst rate, taken as the "
            "<b>average</b> of the observed years rather than the latest year "
            "alone. Loss density and account density are carried forward "
            "(year-on-year rank correlation 0.997 and 0.999), and plant age "
            "advances by one.<br><br>"
            "Extrapolating a per-plant trend was tried and measured "
            "<b>worse than changing nothing</b> — 8.03 places of rank error "
            "against 7.00 for persistence — because with three annual points "
            "a burst 'trend' is mostly the gap between two noisy years, "
            "projected forward. Averaging cancels that noise; extrapolating "
            "amplifies it."), unsafe_allow_html=True)
